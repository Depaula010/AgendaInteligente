...
public interface IProfessionalRepository
{
    ...
    Task<IReadOnlyList<Professional>> GetAllActiveByTenantAsync(Guid tenantId, CancellationToken ct = default);
    ...
    Task<Professional?> GetByIdIgnoringQueryFilterAsync(Guid id, CancellationToken ct = default);
